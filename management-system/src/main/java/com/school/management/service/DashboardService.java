...
public class DashboardService {
    ...
    public SchoolStatsResponse getSchoolStats() {
        ...
        long teachersCount = userRepository.countBySchool_IdAndRoleAndDeletedAtIsNull(schoolId, UserRole.TEACHER);
    ...
    public SystemStatsResponse getSystemStats() {
        ...
        List<SchoolInfoResponse> recentSchoolResponses = recentSchools.stream()
                .map(school -> SchoolInfoResponse.builder()
                        ...
                        .schoolAdminEmail(
                                userRepository.findAdminEmailBySchoolId(school.getId()).orElse(null))
                        .build())
                .collect(Collectors.toList());
    ...
    private SchoolInfoResponse mapToSchoolInfoResponse(School school) {
        ...
        return SchoolInfoResponse.builder()
                ...
                .teachersCount(userRepository.countBySchool_IdAndRoleAndDeletedAtIsNull(schoolId, UserRole.TEACHER))
                .staffCount(userRepository.countBySchool_IdAndRoleAndDeletedAtIsNull(schoolId, UserRole.STAFF))
